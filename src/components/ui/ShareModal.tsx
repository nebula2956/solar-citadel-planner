...
export function ShareModal({ url, error, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {loading && (
          <p style={{ color: '#94a3b8', fontSize: 13 }}>サーバーに保存中...</p>
        )}
        ...
        {url && !error && (
          <>
            <p style={{ color: '#94a3b8', fontSize: 13, margin: '0 0 12px' }}>
              以下のURLをコピーして共有できます。配置・チーム・メンバー情報がすべて含まれます。
            </p>
            <div style={{ display: 'flex', gap: 8 }}>
              <input
                ...
                style={{
                  ...
                  borderRadius: 6, color: '#cbd5e1', fontSize: 12, fontFamily: 'monospace',
                }}
              ...
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer', fontSize: 13, fontWeight: 600, minWidth: 80,
                }}
              >
                {copied ? '✓ コピー済' : 'コピー'}
              </button>
